        ...
        <div className="row gy-4">
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div className="platform-item item-cyan position-relative">
              ...
              <p>Developed and customized e-commerce solutions using Shopware, optimizing performance, integrating payment gateways, and enhancing user experience.</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div className="platform-item item-orange position-relative">
              ...
              <p>Built and implemented ERP systems for manufacturing companies, streamlining operations, automating workflows, and improving resource management.</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div className="platform-item item-teal position-relative">
              ...
              <p>Developed a monitoring portal for customer relationship management, enabling efficient tracking, reporting, and data-driven decision-making.</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div className="platform-item item-red position-relative">
              ...
              <p>Designed and implemented a CMS for an education management system, allowing efficient content organization, user management, and digital resource distribution.</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div className="platform-item item-indigo position-relative">
              ...
              <p>Integrated third-party payment systems into client shops, ensuring secure transactions, seamless checkout experiences, and compliance with financial regulations.</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div className="platform-item item-pink position-relative">
              ...
              <p>Integrated third-party service APIs into various platforms, enabling seamless data exchange, enhanced functionality, and automation of business processes.</p>
            </div>
          </div>
        </div>
      </div>
