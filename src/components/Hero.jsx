...
const Hero = () => {
  return (
    <section id="hero" className="hero section light-background">
      <img src={`${process.env.PUBLIC_URL}/static/media/img/5651978.webp`}  alt="Deepak Aruldoss" loading="eager"/>
      <div className="container" data-aos="zoom-out">
        <div className="row justify-content-center">
          <div className="col-lg-9">
            <h2 data-aos="slide-left" data-aos-delay="100">Deepak Aruldoss</h2>
            <p className="my-designation" data-aos="slide-right" data-aos-delay="200">
              I'm <span className="typed">Senior Software Developer</span>
            </p>
